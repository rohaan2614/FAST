...
#!/usr/bin/bash
#SBATCH --job-name=R_75K_C_10_F_$F
...
python fast_main3.py --dataset=cifar10 --num-clients=$NUM_CLIENTS --f=$F --lr=$LEARNING_RATE --round=$ROUND --log-to-tensorboard=cifar_CNN > "output/\$OUTPUT_LOG" 2> "error/\$ERROR_LOG"
